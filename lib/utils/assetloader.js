import { SwordsmanSprite, GreenSlimeSprite, Ground, GroundLeft, GroundRight, GroundBottom, GroundBottomLeft, GroundBottomRight, GroundFloatLeft, GroundFloatRight, Wall_C_01, Wall_C_03, jumpAudio, steprockAudio, attackAudio } from '../assets';
export function loadPlayerSprites(k) {
...
export function loadEnvironmentAssets(k) {
...
export function loadGameSounds(k) {
